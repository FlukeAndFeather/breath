---
title: "Humpback breathing rates"
...
mn_prh <- readxl::read_excel("prh_guide.xlsx", sheet = "mn") %>% 
  mutate(
...
35/131 deployments with NetCDF

```{r dives}
# Deployment metadata
this_row <- filter(mn_prh, !is.na(prh_path)) %>% slice(1)
this_id <- this_row$id
...
plot_dive_event(this_dives, 1, 60)
```
